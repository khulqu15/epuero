<template>
    <view-layout>
        <template v-slot:content>
            <div class="min-h-screen bg-white w-full relative">
                <img src="/images/fire/cover.webp" class="block absolute top-1/2 left-1/2 w-full h-full object-cover object-center -translate-x-1/2 -translate-y-1/2" alt="Cover"/>
                <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent via-transparent to-white opacity-30"></div>
                <div class="md:container mx-auto relative py-24 px-12">
