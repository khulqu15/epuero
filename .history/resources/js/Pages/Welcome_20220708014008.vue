        ...
        <template v-slot:content>
            ...
            <div class="relative pt-4 pb-12">
                ...
                <div class="md:container mx-auto relative z-40 px-2 md:px-12">
                    ...
                    <!-- Main modal -->
                    <div id="mappingModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
                    ...
                    <div class="grid grid-cols-4 gap-6">
                        <div v-for="(item, index) in 4" class="w-full h-72 relative rounded-lg overflow-hidden col-span-2 md:col-span-1" @click="showModal(item)">
                            <img :src="`/images/mapping/map${item}.png`" class="block absolute top-1/2 left-1/2 w-full h-full object-cover object-center -translate-x-1/2 -translate-y-1/2" alt="News1"/>
                        </div>
                    </div>
                </div>
            </div>
