                ...
                <div class="md:container mx-auto relative z-40 px-2 md:px-12">
                    ...
                    <div class="grid grid-cols-4 gap-6">
                        <div v-for="(item, index) in 4" class="w-full h-64 relative rounded-lg">
                            <img :src="`/images/mapping/map${item}.jpg`" class="block absolute top-1/2 left-1/2 w-full h-full object-cover	object-center -translate-x-1/2 -translate-y-1/2" alt="News1"/>
                        </div>
                    </div>
                </div>
            </div>
