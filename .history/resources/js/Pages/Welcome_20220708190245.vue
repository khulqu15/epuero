    ...
    <view-layout>
        <template v-slot:content>
            <div class="min-h-screen bg-white w-full relative mb-8">
                ...
                <div class="md:container mx-auto relative py-24 px-12 grid grid-cols-2 place-content-center">
                    <div class="col-span-2 md:col-span-1">
                        <h3 class="text-4xl font-bold self-center">Eepis Plane Unit Operational Rescue Forest </h3>
                    </div>
                </div>
            </div>
