            ...
            <div class="relative bg-indigo-600">
                <div class="md:container mx-auto relative z-20 px-2 md:px-12">
                    <div class="grid grid-cols-2 py-36">
                        <div></div>
                        <div>
                            <h2 class="text-4xl mb-6 text-white font-bold">Learn About Method And Procedure</h2>
                            <p class="text-white mb-3">Nunc vitae dolor egestas nibh ornare laoreet. Nulla porta id massa consequat finibus. In ornare purus eu mauris cursus, nec interdum massa hendrerit. Quisque porta auctor eros, ut ultricies lectus maximus a</p>
                            <button type="button" class="py-3 px-8 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Learn More</button>
                        </div>
                    </div>
                </div>
            </div>
