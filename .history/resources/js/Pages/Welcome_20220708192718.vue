            ...
            <div class="min-h-screen bg-white w-full relative mb-8">
                ...
                <div class="md:container mx-auto relative py-24 px-12 grid grid-cols-2 place-content-center min-h-screen">
                    ...
                    <div class="col-span-2 md:col-span-1 relative px-4 md:px-8">
                        ...
                        <div class="absolute left-1/2 md:left-1/3 top-0 space-y-4">
                            <div v-for="(item, index) in 4" class="bg-white p-4 rounded-lg shadow hover:shadow-lg hover:scale-110 flex">
                                <div class="bg-red-100 rounded h-12 w-12 text-center">
                                    <Icon icon="akar-icons:fire" class="inline-block mx-auto"/>
                                </div>
                            </div>
                        </div>
                    </div>
