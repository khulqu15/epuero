                    ...
                    <div class="grid grid-cols-4 gap-6">
                        <div v-for="(item, index) in 4" class="w-full card-mapping h-72 relative rounded-lg overflow-hidden col-span-2 md:col-span-1">
                            ...
                            <div class="hoverable relative w-full h-full bg-gradient-to-b from-indigo-600 to-cyan-400">
                                <button type="button" class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">See Detail</button>
                            </div>
                        </div>
                    </div>
                </div>
