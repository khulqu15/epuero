            ...
            <div class="min-h-screen bg-white w-full relative mb-8">
                ...
                <div class="md:container mx-auto relative py-24 px-12 grid grid-cols-2 place-content-center min-h-screen">
                    <div class="col-span-2 md:col-span-1">
                        <h3 class="text-5xl font-bold self-center mb-3">Eepis Plane Unit Operational Rescue Forest </h3>
                        <p class="text-sm text-gray-700">Pellentesque fringilla diam ligula, ac consequat est tempus eu. Morbi vel malesuada nunc. Vestibulum sit amet orci lacus. Praesent congue luctus turpis in blandit. Etiam mollis rutrum metus at pellentesque. </p>
                    </div>
                </div>
            </div>
