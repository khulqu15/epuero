                    ...
                    <div class="space-y-8">
                        <div class="grid grid-cols-2 gap-8">
                            <div class="text-center">
                                <img src="/images/platform/uav.webp" class="inline-block mx-auto w-4/5" alt="UAV">
                            </div>
                            <div class="space-y-3">
                                <h4 class="text-xl font-semibold">Autonomous  UAV Aircraft</h4>
                                <p class="ml-4">Nunc vitae dolor egestas nibh ornare laoreet. Nulla porta id massa consequat finibus. In ornare purus eu mauris cursus, nec interdum massa hendrerit. Quisque porta auctor eros, ut ultricies lectus maximus a</p>
                            </div>
                        </div>
                    </div>
                </div>
