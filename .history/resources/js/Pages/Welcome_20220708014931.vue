        ...
        <template v-slot:content>
            ...
            <div class="relative pt-4 pb-12">
                ...
                <div class="md:container mx-auto relative z-40 px-2 md:px-12">
                    ...
                    <!-- Main modal -->
                    <div id="mappingModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden z-60 fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
