                ...
                <div class="md:container mx-auto relative z-40 px-2 md:px-12">
                    ...
                    <div class="bg-white shadow-lg rounded-lg p-12 grid grid-cols-4 gap-4">
                        <div class="col-span-4 md:col-span-1 lg:col-span-1 text-center">
                            ...
                            <p class="text-sm text-gray-500">An incredible set of building blocks with dark mode support.</p>
                        </div>
                        <div class="col-span-4 md:col-span-1 lg:col-span-1 text-center">
            ...
            <div class="relative pt-4 pb-12">
                ...
                <div class="md:container mx-auto relative z-40 px-2 md:px-12">
                    <div class="text-center py-4">
                        ...
                        <p class="text-sm">All you need to see geograp is there.</p>
                    </div>
                    ...
                    <div class="my-8 grid grid-cols-2">
                        <div>
                            <div class="inline-block bg-white shadow p-4 rounded-lg">
                                <Icon icon="jam:mountain" class="text-4xl relative -top-8 text-green-700 inline-block"/>
                                <div class="relative ml-4 inline-block">
                                    <h4 class="text-lg font-semibold">Gunung Arjuno</h4>
                                    <p class="text-sm -top-4 text-gray-600">Jawatimur</p>
                                </div>
                            </div>
                        </div>
                    </div>
