<template>
    <view-layout>
        <template v-slot:content>
            ...
            <div class="relative pt-4 pb-12 bg-indigo-700">
                <div class="md:container mx-auto relative z-20 px-2 md:px-12">
                    <div class="grid grid-cols-2">
                        <div></div>
                        <div>
                            <h2 class="text-2xl text-white font-bold">Learn About Method And Procedure</h2>
                            <p class="text-white">Nunc vitae dolor egestas nibh ornare laoreet. Nulla porta id massa consequat finibus. In ornare purus eu mauris cursus, nec interdum massa hendrerit. Quisque porta auctor eros, ut ultricies lectus maximus a</p>
                        </div>
                    </div>
                </div>
            </div>
