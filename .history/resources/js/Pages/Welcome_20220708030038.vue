            ...
            <div class="relative pt-4 pb-12">
                ...
                <div class="md:container mx-auto relative z-20 px-2 md:px-12">
                    ...
                    <div class="my-8 grid grid-cols-3 gap-6">
                        <div>
                            <div class="w-full h-1 my-4 bg-gray-300"></div>
                        </div>
                        <div>
                            <button type="button" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg px-8 py-4 w-full text-center mr-2 mb-2">Show More</button>
                        </div>
                        <div>
                            <div class="w-full h-1 my-4 bg-gray-300"></div>
                        </div>
