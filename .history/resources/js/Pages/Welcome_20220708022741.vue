    ...
    <view-layout>
        <template v-slot:content>
            ...
            <div id="animation-carousel" class="relative" data-carousel="static">
                <div class="overflow-hidden relative h-162 rounded-lg">
                    <div class="hidden duration-200 ease-linear" data-carousel-item="active">
                        ...
                        <div class="caption-header absolute z-30 left-12 bottom-7 inline-block px-6 py-4 rounded-lg bg-gray-200 w-96 sm:w-144">
            ...
            <div class="relative pt-4 pb-12">
                ...
                <div class="md:container mx-auto relative z-30 px-2 md:px-12">
