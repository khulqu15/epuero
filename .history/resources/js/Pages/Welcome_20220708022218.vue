    ...
    <view-layout>
        <template v-slot:content>
            ...
            <div id="animation-carousel" class="relative" data-carousel="static">
                <div class="overflow-hidden relative h-162 rounded-lg">
                    <div class="hidden duration-200 ease-linear" data-carousel-item="active">
                        ...
                        <div class="caption-header absolute z-40 left-12 bottom-7 inline-block px-6 py-4 rounded-lg bg-gray-200 w-96 sm:w-144">
                            <h3 class="text-lg font-semibold mb-3">EPUERO (Eepis Plane Unit Operational Rescue Forest)</h3>
                            <p class="text-sm">Semangat walaupun semuanya yang ada hanyalah rintangan.</p>
                        </div>
                    </div>
                    <div class="hidden duration-200 ease-linear" data-carousel-item>
                        ...
                        <div class="caption-header absolute z-40 left-12 bottom-7 inline-block px-6 py-4 rounded-lg bg-gray-200 w-96 sm:w-144">
                            <h3 class="text-lg font-semibold mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas at, rem asperiores voluptatibus harum est eius!</h3>
                            <p class="text-sm">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque, laborum in. Illum minus quibusdam recusandae rerum at molestias dolorem est!</p>
                        </div>
                    </div>
                    <div class="hidden duration-200 ease-linear" data-carousel-item>
                ...
                <div class="absolute bottom-5 z-30 mx-4">
            ...
            <div class="relative pt-4 pb-12">
                <img src="/images/decoration/home1.webp" class="w-24 md:w-40 absolute z-30 -top-36 right-0" alt="Decoration1">
                <div class="md:container mx-auto relative z-40 px-2 md:px-12">
            ...
            <div class="relative pt-4 pb-12">
                <img src="/images/decoration/home2.webp" class="w-24 md:w-40 absolute z-30 -top-36 left-0" alt="Decoration2">
                <div class="md:container mx-auto relative z-40 px-2 md:px-12">
                    <div class="text-center py-4">
                        ...
                        <div class="col-span-2 md:col-span-1">
                            <div class="inline-block bg-white shadow pt-4 px-4 rounded-lg">
                                ...
                                <div class="relative ml-4 inline-block">
                                    <h4 class="text-lg font-semibold">Gunung Arjuno</h4>
                    ...
                    <div class="grid grid-cols-4 gap-6">
                        <div v-for="(item, index) in 4" class="w-full card-mapping h-72 relative rounded-lg overflow-hidden col-span-2 md:col-span-1" @click="showModal(item)">
                            ...
                            <div class="relative w-full h-full bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500">
                ...
                <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                            ...
                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" @click="closeModal('mappingModal')">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                            </button>
                        </div>
                        <div class="p-6 space-y-6">
                            <img :src="`/images/mapping/map${mapping}.png`" class="h-72 rounded-lg" :alt="`Map${mapping}-detail`">
                            <div>
                                <h6 class="text-lg font-semibold">Image Mapping {{ mapping }}</h6>
                                <span>Senin, 20 Maret 2022 13:35</span>
                            </div>
                        </div>
                        <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                            ...
                            <button @click="closeModal('mappingModal')" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Decline</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        showModal(item) {
            const targetEl = document.getElementById('mappingModal')
            const options = {
        ...
        closeModal(nameId) {
            const targetEl = document.getElementById(nameId)
            const options = {
                backdropClasses: 'bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-60',
            }
            const modal = new Modal(targetEl, options);
