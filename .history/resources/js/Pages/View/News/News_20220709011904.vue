                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-6 space-y-6">
                            <div class="grid grid-cols-4">
                                <div class="w-12 h-12 mx-auto flex rounded-full basis-full bg-cyan-200 text-center justify-items-center">
                                    <Icon icon="akar-icons:twitter-fill" class="text-cyan-600 place-self-center"/>
                                </div>
                            </div>
                        </div>
                    </div>
