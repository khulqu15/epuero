    ...
    <view-layout active="news">
        <template v-slot:content>
            <div class="relative" id="news">
                <div class="grid grid-cols-3 gap-3 overflow-visible">
                    <div class="col-span-2 pt-36 pb-12">
                    ...
                    <div class="min-h-screen w-full border-l border-gray-200 pt-36 pb-12 sticky top-0">
