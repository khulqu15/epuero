                ...
                <div class="grid grid-cols-3 gap-3">
                    ...
                    <div class="col-span-3 md:col-span-1 min-h-screen relative px-8 w-full border-l border-gray-200 pt-36 pb-12 overflow-visible">
                        <div class="sticky top-36">
                            <button class="relative inline-flex items-center justify-center w-full p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800">
                            ...
                            <h3 class="font-semibold text-xl">More awesome news</h3>
                            <a href="/news" class="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <div class="relative w-48">
                                    <img class="object-cover self-stretch w-full h-96 rounded-t-lg md:h-full md:w-48 md:rounded-none md:rounded-l-lg" src="/images/news/news2.jpg" alt="">
                                </div>
                                <div class="flex flex-col justify-between p-4 leading-normal">
                                    ...
                                    <p class="mb-3 font-sm text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
                                </div>
                            </a>
                        </div>
                    </div>
