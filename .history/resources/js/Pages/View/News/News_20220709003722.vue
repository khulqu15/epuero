            ...
            <div class="relative" id="news">
                <div class="grid grid-cols-3 gap-3">
                    <div class="col-span-2 pt-36 pb-12 px-8 space-y-6 md:px-12">
                        <img src="/images/news/news2.jpg" class="w-full rounded-lg" alt="News 1">
                        <div class="space-y-3">
                            <h1 class="text-3xl font-bold">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius, nulla!</h1>
                            <span class="text-gray-400">Monday, 20 April 2022</span>
                        </div>
                        <p>
