                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-6 space-y-6">
                            <div class="grid grid-cols-4">
                                <div class="w-12 h-12 mx-auto flex rounded-full bg-cyan-200 text-center">
                                    <Icon icon="akar-icons:twitter-fill" class="text-cyan-600 inline-block self-center justify-center"/>
                                </div>
                            </div>
                        </div>
                    </div>
