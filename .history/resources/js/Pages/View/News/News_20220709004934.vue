        ...
        <template v-slot:content>
            <div class="relative" id="news">
                <div class="grid grid-cols-3 gap-3">
                    <div class="col-span-2 pt-36 pb-12 px-8 space-y-6 md:px-12">
                    ...
                    <div class="min-h-screen relative px-8 w-full border-l border-gray-200 pt-36 pb-12 overflow-visible">
                        <div class="sticky top-36">
                            ...
                            <a href="#" class="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <img class="object-cover w-full h-96 rounded-t-lg md:h-full md:w-48 md:rounded-none md:rounded-l-lg" src="/images/news/news2.jpg" alt="">
