<template>
    ...
    <view-layout active="geograph">
        <template v-slot:content>
            <div class="relative pt-36 pb-12" id="geograph">
                    ...
                    <div>
                        <div class="my-8 grid grid-cols-2">
                            ...
                            <div class="col-span-2 md:col-span-1 text-right py-4">
                                <select id="countries" class="bg-gray-50 border inline-block border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-auto p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
