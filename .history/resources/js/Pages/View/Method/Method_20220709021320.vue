                            ...
                            <aside class="w-full h-full" aria-label="Sidebar">
                                <div class="overflow-y-auto py-4 px-3 rounded dark:bg-gray-800">
                                    <ul class="space-y-2">
                                        ...
                                        <li>
                                            <a href="#" class="flex items-center bg-gradient-to-r from-cyan-500 to-indigo-600 p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
...
export default {
    ...
    methods: {
        setBody() {
            let body = document.getElementsByTagName('body').classList
        }
    }
}
