        ...
        <template v-slot:content>
            <div class="relative" id="method">
                <div class="grid grid-cols-3 gap-3">
                     <div :class="{'-left-36 opacity-0 invisible hidden': !aside, 'fixed md:relative col-span-3 md:col-span-1 min-h-screen': aside}" class="relative px-8 w-full border-l border-gray-200 overflow-visible">
