        ...
        <template v-slot:content>
            <div class="relative" id="method">
                <div class="grid grid-cols-3 gap-3">
                     <div :class="{'-left-36 opacity-0 invisible hidden': !aside, 'col-span-3 md:col-span-1 min-h-screen': aside}" class="relative px-8 w-full border-l border-gray-200 overflow-visible">
                    ...
                    <div :class="{'md:col-span-3 md:container': !aside, 'md:col-span-2': aside}"  class="col-span-3 md:col-span-2 pt-36 pb-12 px-8 space-y-6 md:px-12 bg-gray-50">
