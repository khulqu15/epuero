        ...
        <template v-slot:content>
            <div class="relative" id="method">
                <div class="grid grid-cols-3 gap-3">
                     <div :class="{'-left-36 opacity-0 invisible hidden relative': !aside, 'fixed z-30 md:relative col-span-3 md:col-span-1 min-h-screen': aside}" class="px-8 w-full border-l border-gray-200 overflow-visible">
